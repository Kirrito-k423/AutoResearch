...
def _formal_row_script(*, config_json: str, row_key: str) -> str:
    script = (
        ...
        "    f'actor_rollout_ref.rollout.mode={row[\"inference_mode\"]}',\n"
        ...
        "    f'actor_rollout_ref.rollout.max_model_len={max_tokens}',\n"
        "    f'actor_rollout_ref.rollout.max_num_batched_tokens={max_tokens}',\n"
