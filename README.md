...
**个人核心能力：懂原理，知得失。** 懂原理，才能把现象归因到模型、数据、系统、硬件和调度机制；知得失，才能判断一次尝试带来了什么、失去了什么、下一步该押什么。

工作循环：紧跟踪，懂原理，准建模，知得失，快穿刺，理差距，评投产，落需求（AI 或员工合作），快开发，实践验，详记录，常修正，有推断，形成设计，见效果，出报告。
