...
- **参数名**：`actor_rollout_ref.actor.megatron.pipeline_model_parallel_size`
- **分类**：效率
- **中文解释**：控制流水并行切分度，降低单卡层数和激活压力，但会引入 pipeline bubble。
- **常见值**：$PP、1、12、16、2、3、6、8
- **来源环境变量**：ACTOR_PP、PP、actor_pp
...
- `examples/dppo_trainer/run_qwen3_30b_a3b_megatron.sh:87` actor_rollout_ref.actor.megatron.pipeline_model_parallel_size=${actor_pp}
- `examples/gspo_trainer/run_qwen3_30b_a3b_megatron.sh:78` actor_rollout_ref.actor.megatron.pipeline_model_parallel_size=${actor_pp}
- `examples/mtp_trainer/run_mimo_7b_mtp_fully_async_megatron_multinode.sh:100` actor_rollout_ref.actor.megatron.pipeline_model_parallel_size=${actor_pp} \
- `examples/mtp_trainer/run_mimo_7b_mtp_megatron.sh:87` actor_rollout_ref.actor.megatron.pipeline_model_parallel_size=${actor_pp}
- `examples/mtp_trainer/run_mimo_7b_mtp_rl_vllm_sgl_megatron.sh:104` actor_rollout_ref.actor.megatron.pipeline_model_parallel_size=${actor_pp}
