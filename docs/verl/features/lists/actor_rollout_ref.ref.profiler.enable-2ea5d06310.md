...
- **参数名**：`actor_rollout_ref.ref.profiler.enable`
- **分类**：配置
...
- `examples/profile/run_qwen3_8b_npu_profile_e2e.sh:92` actor_rollout_ref.ref.profiler.enable=True
- `examples/profile/run_qwen3_8b_npu_profile_discrete.sh:94` actor_rollout_ref.ref.profiler.enable=True
