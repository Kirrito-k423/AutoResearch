...
- **参数名**：`actor_rollout_ref.actor.megatron.grad_offload`
- **分类**：效率
...
- `examples/dppo_trainer/run_qwen3_30b_a3b_megatron.sh:91` actor_rollout_ref.actor.megatron.grad_offload=True
- `examples/gspo_trainer/run_qwen3_30b_a3b_megatron.sh:82` actor_rollout_ref.actor.megatron.grad_offload=True
- `examples/mtp_trainer/run_mimo_7b_mtp_fully_async_megatron_multinode.sh:103` actor_rollout_ref.actor.megatron.grad_offload=False \
- `examples/mtp_trainer/run_mimo_7b_mtp_megatron.sh:90` actor_rollout_ref.actor.megatron.grad_offload=True
- `examples/mtp_trainer/run_mimo_7b_mtp_rl_vllm_sgl_megatron.sh:108` actor_rollout_ref.actor.megatron.grad_offload=True
