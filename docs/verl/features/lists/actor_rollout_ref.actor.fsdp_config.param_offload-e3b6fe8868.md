...
- **参数名**：`actor_rollout_ref.actor.fsdp_config.param_offload`
- **分类**：效率
...
- `examples/reinforce_plus_plus_trainer/run_qwen3_8b_fsdp.sh:69` actor_rollout_ref.actor.fsdp_config.param_offload=False
- `examples/gmpo_trainer/run_qwen3_8b_fsdp.sh:75` actor_rollout_ref.actor.fsdp_config.param_offload=False
- `examples/gspo_trainer/run_qwen3_8b_fsdp.sh:112` actor_rollout_ref.actor.fsdp_config.param_offload=True
- `examples/otb_trainer/run_qwen3_8b_fsdp.sh:69` actor_rollout_ref.actor.fsdp_config.param_offload=False
- `examples/sapo_trainer/run_qwen3_8b_fsdp.sh:83` actor_rollout_ref.actor.fsdp_config.param_offload=True
