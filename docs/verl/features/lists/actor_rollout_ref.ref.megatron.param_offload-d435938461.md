...
- **参数名**：`actor_rollout_ref.ref.megatron.param_offload`
- **分类**：效率
...
- `examples/dppo_trainer/run_qwen3_30b_a3b_megatron.sh:117` actor_rollout_ref.ref.megatron.param_offload=True
- `examples/gspo_trainer/run_qwen3_30b_a3b_megatron.sh:112` actor_rollout_ref.ref.megatron.param_offload=True
- `examples/mtp_trainer/run_mimo_7b_mtp_fully_async_megatron_multinode.sh:125` actor_rollout_ref.ref.megatron.param_offload=False \
- `examples/mtp_trainer/run_mimo_7b_mtp_megatron.sh:110` actor_rollout_ref.ref.megatron.param_offload=True
- `examples/mtp_trainer/run_mimo_7b_mtp_rl_vllm_sgl_megatron.sh:153` actor_rollout_ref.ref.megatron.param_offload=True
