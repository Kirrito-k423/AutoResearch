...
- `examples/profile/run_qwen3_8b_npu_profile_e2e.sh:16` profile_steps=${PROFILE_STEPS:-"[2,4]"}
- `examples/profile/run_qwen3_8b_npu_profile_discrete.sh:16` profile_steps=${PROFILE_STEPS:-"[2,4]"}
