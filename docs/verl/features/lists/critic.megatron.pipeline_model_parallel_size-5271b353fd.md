...
- **参数名**：`critic.megatron.pipeline_model_parallel_size`
- **分类**：效率
...
- `examples/ppo_trainer/run_qwen3_8b_megatron.sh:100` critic.megatron.pipeline_model_parallel_size=${critic_pp}
