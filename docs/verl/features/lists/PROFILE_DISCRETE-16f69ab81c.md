...
- `examples/profile/run_qwen3_8b_npu_profile_e2e.sh:18` profile_discrete=${PROFILE_DISCRETE:-False}
- `examples/profile/run_qwen3_8b_npu_profile_discrete.sh:19` profile_discrete=${PROFILE_DISCRETE:-True}
