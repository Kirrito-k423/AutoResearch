...
- `examples/profile/run_qwen3_8b_npu_profile_e2e.sh:20` profile_level=${PROFILE_LEVEL:-level0}
- `examples/profile/run_qwen3_8b_npu_profile_discrete.sh:21` profile_level=${PROFILE_LEVEL:-level0}
