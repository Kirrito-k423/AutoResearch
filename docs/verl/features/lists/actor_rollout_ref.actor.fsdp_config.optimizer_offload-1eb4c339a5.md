...
- **参数名**：`actor_rollout_ref.actor.fsdp_config.optimizer_offload`
- **分类**：效率
...
- `examples/reinforce_plus_plus_trainer/run_qwen3_8b_fsdp.sh:70` actor_rollout_ref.actor.fsdp_config.optimizer_offload=False
- `examples/gmpo_trainer/run_qwen3_8b_fsdp.sh:76` actor_rollout_ref.actor.fsdp_config.optimizer_offload=False
- `examples/gspo_trainer/run_qwen3_8b_fsdp.sh:113` actor_rollout_ref.actor.fsdp_config.optimizer_offload=True
- `examples/otb_trainer/run_qwen3_8b_fsdp.sh:70` actor_rollout_ref.actor.fsdp_config.optimizer_offload=False
- `examples/sapo_trainer/run_qwen3_8b_fsdp.sh:84` actor_rollout_ref.actor.fsdp_config.optimizer_offload=True
