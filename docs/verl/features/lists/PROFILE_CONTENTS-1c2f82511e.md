...
- `examples/profile/run_qwen3_8b_npu_profile_e2e.sh:21` profile_contents=${PROFILE_CONTENTS:-"['npu','cpu']"}
- `examples/profile/run_qwen3_8b_npu_profile_discrete.sh:22` profile_contents=${PROFILE_CONTENTS:-"['npu','cpu']"}
