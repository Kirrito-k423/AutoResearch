...
- **参数名**：`actor_rollout_ref.ref.megatron.tensor_model_parallel_size`
- **分类**：效率
- **中文解释**：控制张量并行切分度，降低单卡权重/KV 压力，但会增加层内通信。
- **常见值**：${actor_tp、1、2、4、8
- **来源环境变量**：ACTOR_TP、REF_TP、TP、actor_tp
...
- `examples/dppo_trainer/run_qwen3_30b_a3b_megatron.sh:113` actor_rollout_ref.ref.megatron.tensor_model_parallel_size=${actor_tp}
- `examples/gspo_trainer/run_qwen3_30b_a3b_megatron.sh:108` actor_rollout_ref.ref.megatron.tensor_model_parallel_size=${actor_tp}
- `examples/mtp_trainer/run_mimo_7b_mtp_fully_async_megatron_multinode.sh:122` actor_rollout_ref.ref.megatron.tensor_model_parallel_size=${actor_tp} \
- `examples/mtp_trainer/run_mimo_7b_mtp_megatron.sh:107` actor_rollout_ref.ref.megatron.tensor_model_parallel_size=${actor_tp}
- `examples/mtp_trainer/run_mimo_7b_mtp_rl_vllm_sgl_megatron.sh:150` actor_rollout_ref.ref.megatron.tensor_model_parallel_size=${actor_tp}
