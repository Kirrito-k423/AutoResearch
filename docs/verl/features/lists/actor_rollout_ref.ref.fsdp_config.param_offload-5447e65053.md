...
- **参数名**：`actor_rollout_ref.ref.fsdp_config.param_offload`
- **分类**：效率
...
- `examples/reinforce_plus_plus_trainer/run_qwen3_8b_fsdp.sh:85` actor_rollout_ref.ref.fsdp_config.param_offload=True
- `examples/gmpo_trainer/run_qwen3_8b_fsdp.sh:91` actor_rollout_ref.ref.fsdp_config.param_offload=True
- `examples/gspo_trainer/run_qwen3_8b_fsdp.sh:128` actor_rollout_ref.ref.fsdp_config.param_offload=True
- `examples/otb_trainer/run_qwen3_8b_fsdp.sh:85` actor_rollout_ref.ref.fsdp_config.param_offload=True
- `examples/sapo_trainer/run_qwen3_8b_fsdp.sh:100` actor_rollout_ref.ref.fsdp_config.param_offload=True
