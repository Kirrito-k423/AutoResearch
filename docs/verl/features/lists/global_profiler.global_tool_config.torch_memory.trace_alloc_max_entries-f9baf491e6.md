...
- **参数名**：`global_profiler.global_tool_config.torch_memory.trace_alloc_max_entries`
- **分类**：配置
...
- `examples/profile/run_qwen2_5_vl_7b_torch_memory.sh:107` global_profiler.global_tool_config.torch_memory.trace_alloc_max_entries=${trace_alloc_max_entries}
